...
const mint = publicKey("9LZZv6KRqpc1Xc3YepELKmjxpxWkYDZd8R9qDmrjebp7");
...
(async () => {
    try {
        ...
        const data: DataV2Args = {
            name: "Armaam Coin",
            symbol: "ARM",
            uri: "https://emerald-electronic-chameleon-622.mypinata.cloud/ipfs/bafkreiebkkmsmnmovn77o4sofnsrh34f76rwmen6rz6hrvazu266vkcba4",
